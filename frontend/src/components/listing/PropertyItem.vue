...
const pricePerM2 = computed(() => props.property.price / props.property.m2);
    ...
    <div class="p-5 space-y-3">
      <div class="flex items-start justify-between gap-4">
        <div class="min-w-0">
          ...
          <h3 class="mt-1 text-[1.0625rem] leading-snug text-ink font-medium truncate">
            {{ property.title }}
          </h3>
        </div>
        <div class="text-right shrink-0">
          <p class="display-price text-2xl text-ink whitespace-nowrap">{{ property.price }}</p>
