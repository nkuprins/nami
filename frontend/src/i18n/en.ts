export default {
  ...
  addProperty: {
    ...
    buyVatIncluded: 'Buy price includes VAT',
    rentVatIncluded: 'Rent price includes VAT',
  ...
  drawers: {
    ...
    deleteListingDesc:
      'This listing will be permanently removed and cannot be restored.',
    delete: 'Delete',
    edit: 'Edit',
